...
*   [FreeBSD ZFS Tuning Guide](http://wiki.freebsd.org/ZFSTuningGuide)
*   [ZFS Troubleshooting Guide](http://www.solarisinternals.com/wiki/index.php/ZFS_Troubleshooting_Guide)
...
*   [ZFS on Linux FAQ](http://zfsonlinux.org/faq.html#HowDoIInstallIt)
...
*   [RAID-Z](https://docs.google.com/document/pub?id=1Qxo2V3v0mjHAW0Q7OElKlWn97bTwwQ_IKlDJ7zMscdU "https://docs.google.com/document/pub?id=1Qxo2V3v0mjHAW0Q7OElKlWn97bTwwQ_IKlDJ7zMscdU") ([оригинал](https://blogs.oracle.com/bonwick/entry/raid_z_russian "https://blogs.oracle.com/bonwick/entry/raid_z_russian")) + [отличия RAID и RAID-Z](http://uadmin.blogspot.ru/2006/07/raid-and-raidz-details.html) (англ.)
...
### Тюнинг
[Тюнинг ZFS на FreeBSD](http://unixzen.ru/%D1%82%D1%8E%D0%BD%D0%B8%D0%BD%D0%B3-zfs-%D0%BD%D0%B0-freebsd/) Martin Matuška (рус.)

#### Русскоязычная интерпретация ZFS On-Disk Specification от Юрия Воинова:
Анатомия ZFS ([часть 1](http://yvoinov.blogspot.ru/2012/09/zfs-i.html), [часть 2](http://yvoinov.blogspot.ru/2012/09/zfs-ii.html), [часть 3](http://yvoinov.blogspot.ru/2012/09/zfs-iii.html), [часть 4](http://yvoinov.blogspot.ru/2012/09/zfs-iv.html), [часть 5](http://yvoinov.blogspot.ru/2012/09/zfs-v.html),
[часть 6](http://yvoinov.blogspot.ru/2012/09/zfs-vi.html)) Можно изучить для более глубокого понимания структуры файловой системы zfs.

#### Обширная презентация по ZFS
[ZFS Tutorial LISA 2011](http://www.slideshare.net/relling/zfs-tutorial-lisa-2011) (англ.)
...
### Подробнее о vdev
Подробнее о том, [что такое vdev](http://forum.ixbt.com/topic.cgi?id=4:127805-166#4847), виртуальное устройство zfs. **WearWolf**
...
В этой ветке сформировалось (не единогласное) мнение о предпочтительности варианта на gpt разделах. [Подробнее](http://forum.ixbt.com/topic.cgi?id=4:127822:4772#4772) **MikeMac**

### Дедупликацию включать?
__Dedupe (дедупликация)__ даётся не даром [англ. оригинал](http://nex7.com/readme1st), перевод **MikeMac**
...
См. также [О порядке удаления датасета с дедупликацией](http://wiki.nas4free.org/doku.php?id=documentation:setup_and_user_guide:disks_zfs_datasets_dataset)
...
[http://mediaunix.com/2012/08/21/kak-udalit-fajl-esli…s-zfs-na-freebsd/](http://mediaunix.com/2012/08/21/kak-udalit-fajl-esli-net-mesta-na-diske-s-zfs-na-freebsd/)
...
[NAS своими руками (часть 6), #2978](http://forum.ixbt.com/topic.cgi?id=4:127822:2978#2978) - Особенности создания zfs-пула на gpt разделах дисков с AF от **axel77**
...
ZoL GPT раздел создаст сам при создании пула.
Для задания размера сектора есть специальный параметр - ashift (9 для 512 байт и 12 - для 4КБ).
Пример команды создания RAIDZ:
...
[NAS своими руками (часть 6), #4001](http://forum.ixbt.com/topic.cgi?id=4:127822:4001#4001)
Zpool на RAW-устройствах с использованием меток устройств от **iZEN**.
[Пример](http://forum.ixbt.com/topic.cgi?id=4:127822:4013#4013) по этой методике.
__NB__ Способ пригоден для FreeBSD. Если такой пул экспортировать в Solaris, получим пул на сырых дисках,
[метки будут затерты](http://forum.ixbt.com/topic.cgi?id=4:127822:4407#4407).

### Дедупликация - команда zbd
[Общая справка по zdb во FreeBSD](http://forum.ixbt.com/topic.cgi?id=4:127822:3929#3929)
от **RU_Taurus**
...
[Скрипт для автоматизации выполнения snapshot по расписанию](http://forum.ixbt.com/topic.cgi?id=4:127826:1710#1710)
от **Oleg Pyzhov**

### Резервная копия zfs
[Скрипт для backup zfs с помощью zfs send/receive](http://forum.ixbt.com/topic.cgi?id=4:127864:2710#2710)
от **Oleg Pyzhov**

### Потери места при создании raidz и raidz2
[Таблица замера накладных расходов raidz/raidz 2](http://forum.ixbt.com/topic.cgi?id=4:127864:3910#3910)
от **thedix**
...
Успешно решенная **kostya_1983** [Отсюда](http://forum.ixbt.com/topic.cgi?id=4:127826:3386#3386)
и ниже.

Или лучше сразу к [разбору полетов](http://forum.ixbt.com/topic.cgi?id=4:127826:3474#3474).

### Перенос пула
При переносе пула, созданного во FreeBSD,
[тут](http://forum.ixbt.com/topic.cgi?id=4:127822:4365#4365)
и [тут](http://forum.ixbt.com/topic.cgi?id=4:127822:4392#4392) отмечено,
...
[Подробнее](http://forum.ixbt.com/topic.cgi?id=4:127864:52#50).
...
**A.** [мой случай... я сделал себе 8+2 (raidz2 из 10 дисков) - но дисков сразу не имею](http://forum.ixbt.com/topic.cgi?id=4:127822:4067#4067)

**Q.** А какими командами FreeBSD поделить 2T диск на половинки для этого?<br>
**A.** [например, так](http://forum.ixbt.com/topic.cgi?id=4:127819-105#3074)

**Q.** имею raidz1 на 2T дисках. Заменить каждый на 4T - ноль проблем. Но в выхлопе остается несколько шт 2T дисков. Печалька.<br>
**A.** [NAS своими руками (часть 6), #2895](http://forum.ixbt.com/topic.cgi?id=4:127822:2895#2895)
